...
const PHOTO = {
  ...
  pancakes: unsplash("photo-1528207776546-56976ade8906"),
  sandwich: unsplash("photo-1528735609831-bfc7a412b3e3"),
  ...
  chips: unsplash("photo-1604467707321-19767b28bd76"),
  ...
  drink: unsplash("photo-1513558161293-cdae8147b0b7"),
  soda: unsplash("photo-1629203851122-37035fdb8bd3"),
  bbq: unsplash("photo-1544025162-d76690232f06"),
  ...
  potato: unsplash("photo-1518977676601-b2690ace2b1b"),
  soup: unsplash("photo-1547592166-23acba8dcd80"),
  japanese: unsplash("photo-1553621042-f6e14724581e"),
  ...
  friedFish: unsplash("photo-1579208030886-b937da5926b9"),
  shrimp: unsplash("photo-1565680018434-b513d5e5fd47"),
  iceCream: unsplash("photo-1497034825429-c343d7c6e31e"),
  milkshake: unsplash("photo-1572490122747-3968b75cc699"),
  beer: unsplash("photo-1535958636474-b021ee0b70f0"),
  cocktail: unsplash("photo-1514362545850-a2297d04c300"),
